    ...
    <MainTemplate>
      <Container>
        <GenericHtml>
          ...
          <p>
            A Técnica Pomodoro é uma metodologia de produtividade criada por <strong>Francesco Cirillo</strong>, que consiste em dividir o trabalho em
            blocos de tempo (os famosos "Pomodoros") intercalados com pausas. O objetivo é manter o foco total por um período curto e garantir
          ...
          <p>Nosso app segue o conceito original, mas com algumas melhorias e personalizações pra deixar o processo ainda mais eficiente:</p>
          ...
          <p>
            A cada ciclo completado, uma nova task é adicionada automaticamente ao seu histórico, e o app já sugere o próximo ciclo (foco ou
            descanso).
          </p>
          <p>
          ...
          <p>
            Assim, você sempre sabe em que parte do processo está e o que vem a seguir. Não precisa mais anotar no papel ou ficar calculando de
            cabeça!
          </p>

          <h3>📊 Histórico automático</h3>
          <p>
            Todas as suas tarefas e ciclos concluídos ficam salvos no <a href="/history">histórico</a>, com status de completas ou interrompidas.
          ...
          <p>
            <strong>Pronto pra focar?</strong> Bora lá <a href="/">voltar para a página inicial</a> e iniciar seus Pomodoros! 🍅🚀
          </p>
